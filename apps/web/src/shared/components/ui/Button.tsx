...
const VARIANTS: Record<ButtonVariant, string> = {
  primary:
    'bg-yellow text-[#3a2a00] hover:brightness-105 active:brightness-95 shadow-[0_1px_0_rgba(255,255,255,0.25)_inset,0_1px_2px_rgba(0,0,0,0.08)]',
  secondary:
...
/** Bouton de la charte : variantes sémantiques, tailles, icônes lucide optionnelles. */
