...
_SYSTEM_PROMPT = (
    ...
    "3. N'appelle deploy_template QUE lorsque tu as reuni le nom et tous les parametres "
    "requis. Tu ne deploies jamais directement : l'outil produit une proposition que "
    "l'utilisateur confirme ensuite.\n"
