...
export const PERSONAS: ReadonlyArray<Persona> = [
  {
    tag: 'Persona 01', icon: 'graduation-cap', accent: 'cyan',
    name: 'Étudiants',
    headline: 'Du code, pas de Terraform.',
    story:
      "Tu apprends Node, pas l'infra. StackNest te donne une BDD prête en 7 secondes — tu lances ton projet, tu oublies l'ops.",
    bullets: [
  ...
  {
    tag: 'Persona 02', icon: 'code-2', accent: 'yellow',
    name: 'Devs senior',
  ...
  {
    tag: 'Persona 03', icon: 'briefcase', accent: 'cyan',
    name: 'Lead devs PME',
