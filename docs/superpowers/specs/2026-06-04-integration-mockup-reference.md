...
| Charte graphique | Dossier **`docs/brand/`** : PDF + charte vivante (`README.md`) + logos SVG | Marque groupée ; charte transcrite en markdown diffable/searchable, exploitable par devs + IA |
...
- **Marque** (`docs/brand/`, ajouté en couche A) :
  - `charte-graphique.pdf` (2 178 853 octets) — PDF d'origine copié depuis la racine de `mockups`
    (intégrité binaire vérifiée par taille), renommé en slug propre.
  - `README.md` — charte **vivante** en markdown : palette + tokens clair/sombre, typo, logos, ton.
  - `assets/` — 5 logos SVG canoniques (couleur + 4 variantes mono) copiés du mockup.
...
| CA5 | Charte PDF dans `docs/brand/` (2 178 853 octets, intégrité OK) + charte vivante + logos | ✅ |
...
- Charte graphique : `docs/brand/` (PDF d'origine + `README.md` charte vivante + logos SVG)
- Identité runtime (`apps/web`) : ticket dédié « couche B » (tokens + assets + composant Logo en TDD)
